...
describe('How to insert words into trie', () => {
  ...
  it.skip('should not be able to insert blank spaces', () => {

  });

  it.skip('should not be able to insert special characters', () => {
...
describe('How to count words in a trie', () => {
  ...
  it.skip('should be able to count how many words it suggests', () => {
    //possibly better to break this out into it's own separate function
  });
...
describe('How to load and use the built in dictionary', () => {
  ...
  it('should suggest words from the built in dictionary', () => {
    ...
    assert.deepEqual(autocompleteList,
